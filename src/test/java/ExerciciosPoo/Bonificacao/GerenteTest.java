...
class GerenteTest {
        ...
        void testConstructorAndGetters() {
            Gerente gerente = new Gerente("Lara", "222.222.222-22", 8000.0f, "123", 3);
            assertEquals("Lara", gerente.getNome());
            assertEquals("222.222.222-22", gerente.getCpf());
            assertEquals(8000.0f, gerente.getSalario(), 1e-6f);
            assertEquals("123", gerente.getSenha());
            assertEquals(3, gerente.getQtdGerenciados());
        }
        ...
        void testBonificacaoIsTenPercent() {
            Gerente gerente = new Gerente("Julia", "111.111.111-11", 10000.0f, "s", 1);
            assertEquals(10000.0f * 0.10f, gerente.getBonificacao(), 1e-6f);
        }
        ...
        void testSetSenhaNullThrows() {
            Gerente gerente = new Gerente("Lara", "111.111.111-11", 1000.0f, "ok", 0);
        ...
        void testSetSenhaEmptyThrows() {
            Gerente gerente = new Gerente("Julia", "111.111.111-11", 1000.0f, "ok", 0);
            assertThrows(IllegalArgumentException.class,
                    () -> gerente.setSenha(""));
        }
        ...
        void testSetQtdGerenciadosNegativeThrows(int invalid) {
            Gerente gerente = new Gerente("Julia", "111.111.111-11", 1000.0f, "ok", 0);
            assertThrows(IllegalArgumentException.class,
                    () -> gerente.setQtdGerenciados(invalid));
        }
        ...
        void testToStringContainsInfo() {
            Gerente gerente = new Gerente("Julia", "222.222.222-22", 8000.0f, "senha", 2);
            String s = gerente.toString();
